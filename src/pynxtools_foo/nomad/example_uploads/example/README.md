...
This example demonstrates how NOMAD can convert, standardize, and store FOO data.
...
For questions regarding the experiment or this specific example [contact the developers](https://fairmat-nfdi.github.io/pynxtools-foo/contact.html) of this example upload.
